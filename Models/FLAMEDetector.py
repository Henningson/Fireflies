...
class Model(nn.Module):
    def __init__(self, config={'linear_input_features': 5, 'num_filters': [32, 64, 128, 256, 512], 'output_features': [200, 200], 'input_image_dimensions': [512, 512]}, state_dict=None, pretrain=False, device="cuda"):
