...
import drjit as dr
import fireflies.utils.laser_estimation
...
def from_laser(scene, params, laser):
    ...
    hit_points = fireflies.utils.laser_estimation.cast_laser(scene, laser=laser)
    ndc_coords = fireflies.utils.laser_estimation.project_to_camera_space(
        params, hit_points
    )
